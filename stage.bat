...
Robocopy "C:\Users\Eli\Desktop\ssg\.com" "C:\Users\Eli\Desktop\eli.waksbaum.com" /MIR
...
"C:\Program Files (x86)\WinSCP\WinSCP.com" ^
  ...
  /command ^
    ...
    "synchronize remote -mirror C:\Users\Eli\Desktop\eli.waksbaum.com /var/www/staging" ^
    "exit"
